...
cp goweather-bucket-x86/goweather-linux-x86-*.tar.gz gh/artifacts/goweather-linux-x86-${VERSION}.tar.gz
cp goweather-bucket-arm/goweather-linux-arm-*.tar.gz gh/artifacts/goweather-linux-arm-${VERSION}.tar.gz
